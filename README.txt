...
Purpose of software: API program for managing patients arriving at a hospital emergency room (ER). The system assists the doctors and nurses in the ER to decide the next patient
...
to compile program & run (ubuntu):
  ...
  Bonus functions completed are printListReverse. reverseList and releasePatients.
